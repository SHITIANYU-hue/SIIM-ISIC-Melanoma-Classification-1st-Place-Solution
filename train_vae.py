...
from models import Effnet_Melanoma, Resnest_Melanoma, Seresnext_Melanoma,VAE
...
def run(fold, df, meta_features, n_meta_features, transforms_train, transforms_val, mel_idx):
    ...
    auc_max = 0.
    auc_20_max = 0.
    model_file  = os.path.join(args.model_dir, f'{args.kernel_type}_best_fold{fold}_VAE.pth')
    model_file2 = os.path.join(args.model_dir, f'{args.kernel_type}_best_20_fold{fold}_VAE.pth')
    model_file3 = os.path.join(args.model_dir, f'{args.kernel_type}_final_fold{fold}_VAE.pth')
